...
namespace Microsoft.Samples.Kinect.Avateering
{
    ...
    public class AvateeringXNA : Microsoft.Xna.Framework.Game
    {
        ...
        public static readonly string[] Models = {"hulk2", "morpheus2", "poketrainer", "bird"};
        ...
        protected override void LoadContent()
        {
            ...
            // Load the model.
            this.currentModel = Content.Load<Model>(Models[CurrentModelIndex]);
        ...
        protected void BuildJointHierarchy()
        {
            ...
            try
            {
                this.nuiJointToAvatarBoneIndex.Add(JointType.HipCenter, 9 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.Spine, 10 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.ShoulderCenter, 14 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.Head, 15 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.ElbowLeft, 17 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.WristLeft, 18 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.HandLeft, 19 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.ElbowRight, 21 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.WristRight, 22 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.HandRight, 23 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.KneeLeft, 24 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.AnkleLeft, 25 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.FootLeft, 26 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.KneeRight, 28 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.AnkleRight, 29 - 8);
                this.nuiJointToAvatarBoneIndex.Add(JointType.FootRight, 30 - 8);
            }
            catch { }
        }
        ...
        private void HandleInput()
        {
            ...
            if (this.currentKeyboard.IsKeyDown(Keys.F5))
            {
                // If not down last update, key has just been pressed.
                if (!this.previousKeyboard.IsKeyDown(Keys.F5))
                {
            ...
            if (this.currentKeyboard.IsKeyDown(Keys.A))
            {
                if (!this.previousKeyboard.IsKeyDown(Keys.A))
                {
            ...
            if (this.currentKeyboard.IsKeyDown(Keys.Enter))
            {
                if (!this.previousKeyboard.IsKeyDown(Keys.Enter))
                {
        ...
        private void UpdateCamera(GameTime gameTime)
        {
            ...
            if (this.currentKeyboard.IsKeyDown(Keys.PageDown))
            {
                this.cameraDistance += time * CameraZoomIncrement;
            }

            if (this.currentKeyboard.IsKeyDown(Keys.PageUp))
            {
                this.cameraDistance -= time * CameraZoomIncrement;
            }
